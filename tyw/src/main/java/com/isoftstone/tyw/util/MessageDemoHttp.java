...
public class MessageDemoHttp {
	public static void main(String[] args) throws UnsupportedEncodingException{
		//以下为所需的参数，测试时请修改,中文请先转为16进制再发送
		String strReg = "101100-WEB-HUAX-176006";   //注册号（由华兴软通提供）
        String strPwd = "ZKMRMUUM";                 //密码（由华兴软通提供）
         ...
         *  张一青	13521826718	
			...
			张洪亮	13426475702
         */
        String strPhone = "";//手机号码，多个手机号用半角逗号分开，最多1000个
        String strContent = HttpSend.paraTo16("晚上聚餐，大家准备下啊，别忘了"+ (new Date()).toString());       //短信内容
