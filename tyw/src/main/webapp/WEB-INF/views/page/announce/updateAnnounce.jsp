...
<body>
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				...
				<input name="title" class="easyui-validatebox" required="true" value="${announce.title}">
			</div>
			<div class="fitem">
				<label>发布者:</label>
				<input id="level" name="issuedBy" class="easyui-validatebox" required="true" readonly="true" value="${announce.issuedBy}">
			</div>
			
			<div class="ftitle">公告内容</div>
			<div class="fitem">
				<label></label>
				<textarea id="myEditor">${announce.content}</textarea>
				<input id="content" name="content" type="hidden">
			</div>
		</form>
	<div id="dlg-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="saveAnnounce()">修改</a>
