...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/files.js" type="text/javascript"></script>
    <script type="text/javascript">
    	...
    	$(function(){
			$("#excelUploadify").uploadify({
    			...
    			'uploader':'${pageContext.request.contextPath}/form/excelFileUpload',
    			'queueID':'fileQueue',
    			'buttonText': '选择文件',  
    			'height': 20,   
    			'multi':false,
       ...
       <div class="easyui-layout" id="subWrap" fit="true" style="width:100%;height:100%;">
        <div data-options="region:'north',title:'查 询',split:false" style="height:120px;background:#fafafa;">
			...
			<div id="p" style="padding:10px;">  
				<span class="qitem">
					<label>发布日期：</label>
					<input type="text" id="searchBegincreateDate" name="searchBegincreateDate" class="Wdate" onClick="WdatePicker()" style="width:100px;" readonly/>
