...
<form name="discount" method="POST" modelAttribute="discount" >
  ...
  <table width="80%" class="datagrid-header" align="center">
    ...
    <tr> 
      ...
      <td width="76%"><label> 
        <input type="text" name="discountName" value="${discount.discountName}">
    ...
    <tr> 
      ...
      <td >
        <input type="text" name="discountValue" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" value="${discount.discountValue}"> 
        <span class="STYLE1">* &nbsp;&nbsp;只能输入数字.</span></td>
    </tr>
    <tr> 
      <td  class="title2">&nbsp;&nbsp;优惠说明:</td>
      <td >
        <input type="text" name="remark" value="${discount.remark}"></td>
    </tr>
	<tr> 
      <td  class="title2">&nbsp;&nbsp;有效期始:</td>
      <td >
		<input name="strValidStartDate" type="text" class="Wdate" onfocus="WdatePicker({skin:'blue'})" value="${discount.validStartDate}">
        <span class="STYLE1">*</span></td>
    </tr>
    <tr> 
      <td  class="title2">&nbsp;&nbsp;有效期至:</td>
      <td >
		<input name="strValidEndDate" type="text" class="Wdate" onfocus="WdatePicker({skin:'blue'})" value="${discount.validEndDate}">
        <span class="STYLE1">*</span></td>
    </tr>
  </table>
