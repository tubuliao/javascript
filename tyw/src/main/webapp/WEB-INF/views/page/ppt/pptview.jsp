...
<div class="clear"></div>
 ...
 <div class="search_up2" ></div>   
  ...
  <div class="search_content">
  	...
  	<input id="kId" name="kId" type="hidden" value="${pp.id }" />
   <div class="weizhi">
   	  ...
   	  <div class="detail_title" id='title02'><c:out value="${pp.title}"/></div>
        <div class="title2">
        				发布时间：<fmt:formatDate value="${pp.begincreateDate}" type="both" dateStyle="long" timeStyle="long" />&nbsp;&nbsp;&nbsp;&nbsp;
						数据来源：<a href="javascript:void(0);" onclick="bookDetail();"><span id="sourceDetail"><c:out value="${pp.source}"/></span></a>
		...
		<div class="wenzi"> 
			<div id="container">
		    <div id="gallery" class="ad-gallery" style="margin-left:30px; width:800px">
		        ...
		        <div class="ad-thumbs">
		          <ul class="ad-thumb-list">
		            <c:forEach items="${imageUrls}" var="PICURL">
			        	<li>
			              <a href="${PICURL.url}">
			                <img src="${PICURL.url}" width="80" height="60" class="image0" alt="${PICURL.title}" >
			              </a>
			            </li>
		        	</c:forEach>
		          </ul>
        ...
        <c:if test="${not empty listpptdown}">
        <div align="center" class='xia20'><img src="/images/detail_16.gif" width="694" height="16" /></div>
            ...
            <ul class="left" style="font-size:14px; line-height:25px;">
       			 <c:forEach items="${listpptdown}" var="pptdown" varStatus="index">
 		                   	<li> 
 		                   		<a style="color:blue" href="javascript:BrowseFolder('${pptdown.urls}','${pptdown.title}')"  >${pptdown.title}${pptdown.suffix} </a> 
 		                 	</li>
 				 </c:forEach>
 		   </ul>
 		   </c:if>
...
<div class="btn_fd">
	<a href="#"><img title="留言" src="${pageContext.request.contextPath}/images/btnfd_10.gif" /></a>
