...
<head>
    ...
    <script type="text/javascript">
		...
		function saveSource() {
			...
			$('#catalog').val(editor_a.getContent()) ;
			$('#description').val(editor_b.getContent()) ;
			//alert('xxx') ;
			$('#fm').form('submit', {
				...
				success: function(result) {
					...
					if(result.success) {
						window.location.href = '${pageContext.request.contextPath}/source' ;
					} else {
...
<body>
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>标准类型:</label>
				<input name="standardType" class="easyui-validatebox" required="true" style="width:500px;" />
			</div>
			<br />
			<div class="fitem">
				<label>标准名称:</label>
				<input name="standardName" class="easyui-validatebox" required="true" validType="validateUser[5,18]" style="width:500px;" />
			</div>
			<br />
			<div class="fitem">
				<label>标准编号:</label>
			...
			<div class="fitem">
				<label>英文名称:</label>
				<input name="englishName" class="easyui-validatebox" required="true" style="width:500px;" />
			</div>
			<br />
			<div class="fitem">
				<label>主编单位:</label>
				<input name="editDepartment" class="easyui-validatebox" validType="validateLen[25]" style="width:500px;" />
			</div>
			<br />
			<div class="fitem">
				<label>批准部门:</label>
				<input name="approveDepartment" class="easyui-validatebox" validType="validateLen[25]" style="width:500px;" />
			</div>
			<br />
			<div class="fitem">
				<label>实施日期:</label>
				<input type="text" class="Wdate" name="executeDate02" id="executeDate02" onClick="WdatePicker()" style="width:200px;" />
			</div>
			<br />
			<div class="ftitle">标准目次:</div>
			<div class="fitem">
				<label></label>
				<textarea id="myEditor02"></textarea>
				<input id="catalog" name="catalog" type="hidden" />
			</div>
			<br />
			<div class="fitem">
				<label>标准目的:</label>
				<input name="goal" class="easyui-validatebox" style="width:500px;" />
			</div>
			<br />
			<div class="fitem">
				<label>适用范围:</label>
				<input name="scope" class="easyui-validatebox" style="width:500px;" />
			</div>
			<br />
			<div class="ftitle">标准介绍</div>
			<div class="fitem">
				<textarea id="myEditor01"></textarea>
