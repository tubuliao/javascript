...
<body>
	    ...
	    <div class="person_nav2">
                ...
                <a class="present" href="/personCentertoValidateEmail">密保邮箱</a>
            <a href="#">我的积分</a>
            <a href="#">我的等级</a>
            <a href="#">安全中心</a-->
	        </ul>
    	...
    	<div class="order_title">保密邮箱<span class="order_title_en"> / secret e-mail</span> </div>
    	<form id="form2" name="form2" method="post" action="">
    	  <table width="700" border="0" cellpadding="0" cellspacing="0" class="code">
            <tr>
              <td height="40" colspan="3" align="left" valign="bottom"><div class="xiaxuxian"><span class="yanhei_hui zuo10">忘记密码时可通过保密邮箱重置密码！</span></div></td>
            </tr>
            <tr>
              <td height="60" colspan="3" align="left"><div class="xiaxuxian">
                <div class="regist_liucheng zuo10">
                  <ul>
            ...
            <tr>
              <td width="85" height="50" align="right">保密邮箱：</td>
              <td width="217" height="50"><input class="login_input" name="textfield3" type="text" id="textfield3" size="30" /></td>
              <td width="396" height="50" class="login_tishi">请输入您的邮箱地址</td>
            </tr>
            <tr>
              <td width="85" height="40" align="right">验证码：</td>
              <td width="217" height="40"><input class="login_input" name="textfield4" type="text" id="textfield4" size="30" /></td>
              <td width="396" height="40" class="login_tishi">不区分大小写</td>
            </tr>
            <tr>
              <td height="40" align="right">&nbsp;</td>
              <td height="40"><img src="../images/personal/untitled.gif" width="100" height="40" /> 看不清，<a href="#">换一换</a></td>
              <td height="40">&nbsp;</td>
            </tr>
            <tr>
              <td align="right">&nbsp;</td>
