...
<body>
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>名称:</label>
				<input name="name" class="easyui-validatebox" required="true" validType="validName" style="width:200px;"/>
			</div>
			<div class="fitem">
				<label>长度:</label>
				<input name="len" class="easyui-validatebox" required="true" validType="validLen" style="width:200px;"/>
			</div>
		</form>
