...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/knowledgeSort.js" type="text/javascript"></script>
    <style type="text/css">
        #fm{
			margin:0;
			padding:10px 30px;
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
    <div region="north" title="查 询" style="height: 100px;background:#fafafa;" id="west">
    	<div id="p" style="padding:10px;">  
			<table>
				<tr>
					<td>
						<span class="qitem" >
							<label>知识分类:</label>
							<select name="knowledgeSort" onchange="changeTitle();">
								<option value="1" selected>分部分项</option>
								<option value="2">地区</option>
								<option value="3">人员分类</option>
								<option value="4">知识性质</option>
							</select>
						</span>
					</td>
					<td>
			...
			<a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="query()" style="margin-top:5px;margin-left:400px;">查询</a> 
		</div> 
    </div>
