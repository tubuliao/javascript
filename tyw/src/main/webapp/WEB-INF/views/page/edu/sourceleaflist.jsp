...
<link rel=stylesheet type=text/css
	href="${pageContext.request.contextPath}/css/kejian.css">
	...
	<script type="text/javascript">
		...
		function getDataList(index) {
			...
			$
					.ajax({
						type : "get",
						url : "${pageContext.request.contextPath}/getEducationSourceListBySource",
						data : "pageNo=" + (pageIndex + 1) + "&pageSize="
								+ items_per_page + "&sourceId="
								+ $("#sourceId").val() + "&" + Math.random(),
						dataType : 'json',
							...
							$
									.each(
											...
											function(i, n) {
												...
												html += "</td>";
												html += "<td height='30' align='center'>";
												html += "<a target='_blank' href='${sourcewareurl}"+n.sourceWareurlFirst+"/content.htm'>进入</a>";
												html += "</td>";
...
<body>
	<div class="body">
		...
		<input id="sourceId" name="sourceId" value="${eduSource.id }" type="hidden" />
			...
			<div class="new_body">
				<div class="new_right">
					...
					<div class="new_position">
						<img src="../images/new/new_08.gif" /> 位置：<a href="/toPackageList">专题列表</a>><a href="/toEduSourceList?packageId=${pack.id}">${pack.title }</a>><a href="/toSourceLeafList?sourceId=${eduSource.id}&packageId=${pack.id}">${eduSource.sourceName }</a>>
					</div>
					<div class="new_right_mulu">
						<div class="new_right_book_title">
							<div class="left">课节列表</div>
							<div class="clear"></div>
						</div>
						<div class="mulu_list">
