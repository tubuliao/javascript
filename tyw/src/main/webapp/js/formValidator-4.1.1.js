...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		$.ajax({async:false,type: "GET",url: "js/theme.js",dataType: "script",
			error :function(){
				//alert(themedir+'当前皮肤加载出错，请确认皮肤【'+settings.theme+'】是否存在')
				}
		}); 
		//读取主题对应的样式
		if($.browser.msie)
		...
		else
		{
			...
			var styCss = "@import url('style/style.css');";
...
//			$.formValidator.setTipState(elem,elem.lastshowclass,elem.lastshowmsg);
	...
	localTooltip : function(e)
	{
		...
		$("#fvtt").css({"top":(mouseY+100)+"px","left":100+"px"});
	},
