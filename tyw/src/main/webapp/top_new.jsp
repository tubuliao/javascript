...
<link rel="icon" href="${pageContext.request.contextPath}/favicon.ico" type="image/gif"/>
     <div class="top-box">
	    <div  class="top-login">
	        <img src="${pageContext.request.contextPath}/newstart/images/newstart_02.gif" />
	    ...
	    <div class="ggao zuo20">
		    <div class="left"><img class="ggaoimg" src="${pageContext.request.contextPath}/images/home/speaker_03.png" /> 公告：</div> 
		    <c:choose>  
		...
		<div class="right">
	        ...
	        <a href="javascript:void(0);" class="hrefs" onclick="SetHome(this,'http://www.tianyouwang.net');">设为首页</a> | <a href="javascript:void(0);"><span style="CURSOR: hand" onclick="AddFavorite('http://www.tianyouwang.net','一个专业的建筑网站---天佑网')" title="网址">收藏本站</span></a>
        </div>
    </div>
   <!-- 第一次登陆欢迎提示start -->
 	...
 	$.post("/announcelist/data",function(result){
 		var total = result.total;
 		 $.each(result.rows,function(i,t){
 			 if(i == 0){
 				html1= "<a href='/announcetotallist' target='_blank'><img src='/images/home/new.gif' />"+(i+1) + "." + t.title + "</a>&nbsp;&nbsp;&nbsp;&nbsp;";
 			 }else if(i == 1){
 				html2= "<a href='/announcetotallist' target='_blank'><img src='/images/home/new.gif' />"+(i+1) + "." + t.title + "</a>&nbsp;&nbsp;&nbsp;&nbsp;"; 
 			 }else{
 				html+= "<a href='/announcetotallist' target='_blank'>"+(i+1) + "." + t.title + "</a>&nbsp;&nbsp;&nbsp;&nbsp;"; 
 			 }
 		 });
